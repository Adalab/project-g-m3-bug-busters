...
class CardsFormDesign extends React.Component {
  ...
  render() {
    return (
      <fieldset className={`form__fieldset ${this.props.visible}`} id = "first"  onClick = {this.props.divAction} >
          ...
          <div className="theme">
            <label htmlFor="t1" className="theme__row">
              <input
                ...
                name="palette"
                value="1"
                checked={this.props.paletteValue === 1}
          ...
          <div className="theme">
            <label htmlFor="t2" className="theme__row">
              <input
                ...
                name="palette"
                value="2"
                checked={this.props.paletteValue === 2}
                onChange={this.props.RadioValue}
              />
              <ul className="colors">
          ...
          <div className="theme">
            <label htmlFor="t3" className="theme__row">
              <input
                ...
                name="palette"
                value="3"
                checked={this.props.paletteValue === 3}
                onChange={this.props.RadioValue}
              />
              <ul className="colors">
